              ...
              <table className="table-fixed border-2 text-center border-solid ">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border-2 p-2">
                      ANA MARIA MONTALVAN LAGOS
                    </td>
                    <td className="border-2 p-2 text-lime-600 font-bold">
                      INGRESADA
                    </td>
                    <td className="border-2 p-2 ">
                    <Link href="/gestion/Paciente" className="bg-cyan-800 rounded-md p-1 text-white">
                        Detalles
                     </Link>
                    </td>
                  </tr>
